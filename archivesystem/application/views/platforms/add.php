            ...
            <div class="breadcrumb-row">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?= site_url('platforms'); ?>">Platforms</a>
                    </li>
                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-header-custom">
                                <i class="fas fa-user-plus"></i> Add Platform
                            </div>

                            <!-- Card Body with Form -->
                            <div class="card-body">
                                <form id="ajaxForm" action="<?= site_url('platforms/add'); ?>" method="post">
                                    <div class="mb-3">
                                        <label class="form-label">App Platform</label>
                                        <input type="text" name="app_platform" class="form-control" required>
                                    </div>

                                    <div class="text-end">
                                        <a href="<?= site_url('platforms'); ?>" class="btn btn-danger"> <i class="fas fa-arrow-left me-2"></i>Cancel</a>
                        ...
                        if(res.status === 'success') {
                            Swal.fire({
                                ...
                                if(result.isConfirmed){
                                    ...
                                    // reset form to allow adding another platform
                                    form[0].reset();
                                }
                            });
                            ...
                            Swal.fire('Error', res.message || 'Failed to add platform.', 'error');
                        }
                    },
                    error: function(xhr) {
                        console.error(xhr.responseText);
                        Swal.fire('Error', 'An error occurred while adding the platform.', 'error');
                    }
                });
            });
        });
